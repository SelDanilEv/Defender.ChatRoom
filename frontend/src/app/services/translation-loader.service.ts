...
const translations: { [lang: string]: { [key: string]: string } } = {
  en: {
    ...
    'room.micTrackEnded': 'Microphone track ended. Please allow microphone access again.',
    'room.healthIssues': 'Connection or audio issues detected.',
    'room.retryConnection': 'Retry',
    'room.participantLeft': '{{name}} left the call.',
    'room.participantLeftDisconnected': '{{name}} disconnected.',
    'room.participantLeftReconnected': '{{name}} reconnected from another tab.',
  ...
  ru: {
    ...
    'room.micTrackEnded': 'Трек микрофона завершился. Разрешите доступ к микрофону снова.',
    'room.healthIssues': 'Обнаружены проблемы с подключением или звуком.',
    'room.retryConnection': 'Повторить',
    'room.participantLeft': '{{name}} покинул(а) звонок.',
    'room.participantLeftDisconnected': '{{name}} отключился(ась).',
    'room.participantLeftReconnected': '{{name}} переподключился(ась) с другой вкладки.',
  ...
  bl: {
    ...
    'room.micTrackEnded': 'Трек мікрафона скончыўся. Дазвольце доступ да мікрафона зноў.',
    'room.healthIssues': 'Выяўлены праблемы з падключэннем або гукам.',
    'room.retryConnection': 'Паспрабаваць зноў',
    'room.participantLeft': '{{name}} выйшаў(ла) са званка.',
    'room.participantLeftDisconnected': '{{name}} адключыўся(лася).',
    'room.participantLeftReconnected': '{{name}} перападключыўся(лася) з іншай укладкі.',
